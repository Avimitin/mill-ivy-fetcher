...
in
{
  ...
  "com.lihaoyi_mill-libs-javalib-maven-worker_3-1.1.2" = fetchMaven {
    name = "com.lihaoyi_mill-libs-javalib-maven-worker_3-1.1.2";
    urls = [
      "https://repo1.maven.org/maven2/com/lihaoyi/mill-libs-javalib-maven-worker_3/1.1.2/mill-libs-javalib-maven-worker_3-1.1.2.jar"
      "https://repo1.maven.org/maven2/com/lihaoyi/mill-libs-javalib-maven-worker_3/1.1.2/mill-libs-javalib-maven-worker_3-1.1.2.pom"
    ];
    hash = "sha256-JlsKvgsoxDHTlL5DCPhS8HNs5yKcG6GljCEGmg+UJK0=";
    installPath = "https/repo1.maven.org/maven2/com/lihaoyi/mill-libs-javalib-maven-worker_3/1.1.2";
  };
  ...
  "org.scala-lang_scala3-library_3-3.7.1" = fetchMaven {
    ...
    urls = [
      "https://repo1.maven.org/maven2/org/scala-lang/scala3-library_3/3.7.1/scala3-library_3-3.7.1.pom"
    ];
    hash = "sha256-inE0QEyu4pZ/CQ5dXjQmUr+GkX6SqRAqANSZvjA5z3Y=";
